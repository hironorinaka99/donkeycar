        ...
        def run(self, mode,
            ...
            if mode == 'user': 
                ...
                if distanceL - dis_L_range < dis_L_LKA_range and distanceL - dis_L_range >0: #左センサーが反応範囲に近いとき（マイナス値は除く）
                    ...
                    LKAadd = 0.0 + (dis_L_LKA_range - (distanceL - dis_L_range)) * dis_LR_value #元は0.1 +LKA_Rangeの残り分ｘ係数
                    pilot_angle += LKAadd 
                ...
                if distanceR - dis_R_range < dis_R_LKA_range and distanceR - dis_R_range >0: #右センサーが反応範囲に近いとき（マイナス値は除く）
                    ...
                    LKAadd = 0.0 + (dis_R_LKA_range - (distanceR - dis_R_range)) * dis_LR_value #元は　0.1 +LKA_Rangeの残り分ｘ係数　           
                    pilot_angle -= LKAadd
